...
const file = 'src/components/settings/CompanySettings.tsx';
let content = readFileSync(file, 'utf8');

const startMarker = '      {/* Data Management Tab */}';
const endMarker = '      {/* App Updates Tab */}';
...
console.log(`Start: ${startIdx}, End: ${endIdx}, Section length: ${endIdx - startIdx}`);

const before = content.substring(0, startIdx);
const after = content.substring(endIdx);

const newSection = `      {/* Data Management Tab */}
