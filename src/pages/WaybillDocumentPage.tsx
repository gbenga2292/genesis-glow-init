                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                                <h1 className="text-base sm:text-xl md:text-2xl font-bold tracking-tight truncate">Waybill {waybill.id}</h1>
            ...
            <div className="flex-1 overflow-auto">
                <div className="max-w-5xl mx-auto p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 md:space-y-6 pb-20 sm:pb-6">
                    ...
                    <div className="bg-muted/30 p-3 sm:p-4 md:p-6 rounded-lg">
                        <h2 className="text-sm sm:text-base md:text-lg font-semibold mb-2 sm:mb-3 md:mb-4">Delivery Information</h2>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
                            <div className="space-y-2 sm:space-y-3">
                                <div className="flex items-center gap-2">
                                    <Calendar className="h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground shrink-0" />
                                    <div className="min-w-0">
                                        <p className="text-[10px] sm:text-xs md:text-sm text-muted-foreground">Sent to Site Date</p>
                    ...
                    {/* Items Table */}
                    <div>
                        <h2 className="text-sm sm:text-base md:text-lg font-semibold mb-2 sm:mb-3 md:mb-4">Items Issued</h2>
                        {isMobile ? (
                            // Mobile View: Cards
                            <div className="space-y-2 sm:space-y-3">
                                        ...
                                        <div className="grid grid-cols-2 gap-1.5 sm:gap-2 text-[10px] sm:text-xs">
                                            ...
                                            <div className="col-span-2">
                                                <Badge
                                                    ...
                                                    className={`text-[10px] sm:text-xs ${item.status === 'outstanding' && (waybill.status === 'sent_to_site' || waybill.status === 'partial_returned') ? 'bg-blue-500 hover:bg-blue-600 text-white border-transparent' : ''}`}
                                                >
